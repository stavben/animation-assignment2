    ...
    const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
  ...
  if (V.rows() == 0 && F.rows() == 0)
  {
	...
	image_texture("C:/dev/animation/EngineForAnimationCourse-master/tutorial/textures/snake1.png");
//    grid_texture();
  }
  else
  {
...
void igl::opengl::ViewerData::setBox() {
...
//assignment2
void::igl::opengl::ViewerData::drawBox(Eigen::AlignedBox<double, 3> m_box, Eigen::RowVector3d color) {
   // std::cout << "drawbox";
    Eigen::MatrixXd boxPoints(8, 3);
