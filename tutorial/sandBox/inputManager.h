...
static void glfw_key_callback(GLFWwindow* window, int key, int scancode, int action, int modifier)
{
	...
	if (key == GLFW_KEY_ESCAPE && action == GLFW_PRESS)
		...
		case GLFW_KEY_UP:
			...
			//scn->data().TranslateInSystem(scn->GetRotation(), Eigen::Vector3d(0, 0.5, 0));
			scn->y_direction = scn->y_direction + 0.01;
			break;
		case GLFW_KEY_DOWN:
			//rndr->TranslateCamera(Eigen::Vector3f(0, -0.01f,0));
			//scn->data().TranslateInSystem(scn->GetRotation(), Eigen::Vector3d(0,-0.5, 0));
		...
		case GLFW_KEY_LEFT:
			...
			//scn->data().TranslateInSystem(scn->GetRotation(), Eigen::Vector3d(-0.5, 0, 0));
			scn->x_direction = scn->x_direction - 0.01;
			break;
		case GLFW_KEY_RIGHT:
			//rndr->TranslateCamera(Eigen::Vector3f(0.01f, 0, 0));
			//scn->data().TranslateInSystem(scn->GetRotation(), Eigen::Vector3d(0.5, 0, 0));
